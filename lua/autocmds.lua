...
-- Thank you Maria!
-- local user = 'mariasolos'
local user = 'mreinhardt'

vim.api.nvim_create_autocmd('FileType', {
    group = vim.api.nvim_create_augroup(user .. '/big_file', { clear = true }),
...
vim.api.nvim_create_autocmd('VimEnter', {
    group = vim.api.nvim_create_augroup(user .. '/dotfiles_setup', { clear = true }),
